...
export const animeListStatusFilterSchema = animeStatusSchema.or(
	z.enum(["all"]),
);
export type AnimeListStatusFilter = z.infer<typeof animeListStatusFilterSchema>;

export const animeListStatusFilterToIdMap: Record<
...
export const animeListStatusFilterIdToStatusFilter = z.codec(
	...
	animeListStatusFilterSchema,
	{
		...
		decode(statusId) {
			...
			) as Entries<typeof animeListStatusFilterToIdMap>;
